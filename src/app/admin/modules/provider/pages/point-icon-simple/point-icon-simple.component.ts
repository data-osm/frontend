...
@Component({
  selector: 'app-point-icon-simple',
  templateUrl: './point-icon-simple.component.html',
  styleUrls: ['./point-icon-simple.component.scss']
})
export class PointIconSimpleComponent implements OnInit {
