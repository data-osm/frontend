...
export class TramLineString extends FlatLineStringLayer {
        ...
        return this.getTexture().pipe(
            map((railTextures) => {
                const material = new ShaderMaterial({
                    ...
                    vec4 textureColor = texture2D(UrailDiffuse, vUv);
