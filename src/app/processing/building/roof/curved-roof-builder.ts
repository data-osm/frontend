...
import { Tile3DRingType } from "../tile-3d-ring";
import { RoofBuilder, RoofGeometry, RoofParams } from "./type";
import { calculateSplitsNormals, signedDstToLine } from "./utils";
import { getPolygonCentroid, isPointInsidePolygon } from "../../math/utils";
        ...
        for (let i = 0; i < points.length - 1; i++) {
            ...
            for (let j = 0; j < arr0.length - 1; j++) {
                ...
                for (let i = 0; i < triPoints.length; i++) {
                    ...
                    const distanceX = uvProgressX + signedDstToLine(position.xy, segmentPerpendicular);
