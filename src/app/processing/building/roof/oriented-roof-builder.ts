...
import { RoofBuilder, RoofGeometry, RoofParams, RoofSkirt, RoofSkirtPolyline } from "./type";
import { splitPolygon, calculateRoofNormals, getIntersectionLineLine, getPointProgressAlongLineSegment, getRotationVectorsFromOMBB, signedDstToLine, calculateSplitsNormals } from "./utils";
